                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String phone = jsonObject1.getString("Website");
                                String father = jsonObject1.getString("Head");
                                String mother = jsonObject1.getString("Slogan");
                                String address = jsonObject1.getString("Address");
                                String cclass = jsonObject1.getString("Phone");
