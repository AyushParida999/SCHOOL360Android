...
public class ExamRecyclerViewAdapter extends RecyclerView.Adapter<ExamRecyclerViewAdapter.DataObjectHolder> {
    ...
    public ExamRecyclerViewAdapter(ArrayList<ExamScheduleDataObject> myDataset) {
        mDataset = myDataset;
    }
    @Override
