...
public class SubjectDetailsRecyclerViewAdapter extends RecyclerView.Adapter<SubjectDetailsRecyclerViewAdapter.DataObjectHolder> {
    private static String LOG_TAG = "TeacherDetailsRecyclerViewAdapter";
    private ArrayList<SubjectDetailsDataObject> mDataset;
...
//            balance = (TextView) itemView.findViewById(R.id.balance);
    ...
    public SubjectDetailsRecyclerViewAdapter(ArrayList<SubjectDetailsDataObject> myDataset) {
        mDataset = myDataset;
    }
    @Override
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.subject_cards, parent, false);
...
//        holder.balance.setText(mDataset.get(position).getmBalance());
    ...
    public void addItem(SubjectDetailsDataObject dataObj, int index) {
