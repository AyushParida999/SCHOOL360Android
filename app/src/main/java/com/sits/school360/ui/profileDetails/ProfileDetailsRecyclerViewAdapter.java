...
import com.sits.school360.ui.transportDetails.TransportDetailsDataObject;

import java.util.ArrayList;

public class ProfileDetailsRecyclerViewAdapter extends RecyclerView.Adapter<ProfileDetailsRecyclerViewAdapter.DataObjectHolder> {
    private static String LOG_TAG = "FeeSummaryRecyclerViewAdapter";
    private ArrayList<ProfileDetailsDataObject> mDataset;
    ...
    public ProfileDetailsRecyclerViewAdapter(ArrayList<ProfileDetailsDataObject> myDataset) {
        mDataset = myDataset;
    }
    @Override
    ...
    public void addItem(ProfileDetailsDataObject dataObj, int index) {
